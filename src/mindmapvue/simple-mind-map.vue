<template>
    <div>
        ...
        <div @click="greet()" style="height: 40px;width: 200px;background-color: aqua;">anniu</div>
        <div id="mindMapContainer" :style="{ height: mydata.initHeight }"></div>
        <!-- <div id="mindMapContainer" style="height:1000px"></div> -->
...
<script lang="ts">
import { createApp,defineComponent,ref, onMounted,onUnmounted, shallowRef,reactive,provide,inject,nextTick} from "vue";
    ...
    setup(props) {
        ...
        onMounted(() => {
            ...
            nextTick(() => {
                ...
                // this.elementHeight=pro.initElementHeight?this.initElementHeight:'400px'
                // debugger;
                ...
                if(props.showMiniMap){
                    createApp(Navigator, { mindMap:mindMap,app:props.app,contentEl:props.contentEl}).mount(props.contentEl.querySelector("#miniMap"));
                }
            });
